...
class _$UserModelImpl implements _UserModel {
  ...
  @override
  String toString() {
    return 'UserModel(userId: $userId, username: $username, password: $password, email: $email, phone: $phone, fullName: $fullName, birthDate: $birthDate, role: $role, avatar: $avatar, idCardNumber: $idCardNumber, address: $address, bankInfo: $bankInfo, status: $status, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
...
abstract class _UserModel implements UserModel {
  factory _UserModel(
      ...
      final String? status,
      final dynamic createdAt,
      final dynamic updatedAt}) = _$UserModelImpl;
