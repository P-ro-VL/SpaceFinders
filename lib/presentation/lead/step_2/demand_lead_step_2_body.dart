...
import 'package:spacefinder/utils/currency_input_formatter.dart';

import '../../../constants.dart';
import '../../../l10n/app_l18.dart';
import '../create/create_lead_layout_c.dart';

class DemandLeadStep2Body extends StatefulWidget {
  const DemandLeadStep2Body({super.key});

  @override
  State<DemandLeadStep2Body> createState() => _DemandLeadStep2BodyState();
}

class _DemandLeadStep2BodyState extends State<DemandLeadStep2Body>
    with FormMixin {
