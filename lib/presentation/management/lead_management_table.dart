...
class _LeadManagementTableState extends State<LeadManagementTable> {
  late LeadTableDataSource dataSource;

  @override
  void initState() {
    dataSource = LeadTableDataSource(leads: widget.leads);
    super.initState();
  }
        ...
        children: [
          Row(
            ...
            children: [
              ...
              if (Get.find<LeadManagementController>().hasFilter)
                GestureDetector(
                  onTap: () {
                    Get.find<LeadManagementController>().clearFilter();
                  },
                  child: Container(
                    width: 160,
          ...
          Container(
              ...
              child: SfDataPager(
                delegate: dataSource,
                pageCount: max(1, widget.leads.length / 4),
